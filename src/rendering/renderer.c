...
static void render_ssao(renderer* dr) {
  ...
  float ssaowidth  = width  * option_graphics_float(asset_hndl_ptr(&dr->options), "ssao", 1, 0.5, 0.25);
  float ssaoheight = height * option_graphics_float(asset_hndl_ptr(&dr->options), "ssao", 1, 0.5, 0.25);
